									...
									<form action="saveuser" method="post" novalidate>
											...
											<div class="row">
												<div class="col-sm-6">
													<label><strong>First Name</strong></label> <input
														...
														name="firstName"> <span class="text-danger">${result.getFieldError("firstName").getDefaultMessage()}</span>
												</div>
										...
										<div class="form-group">
											<label><strong>Password</strong></label> <input
												...
												name="password"> <span class="text-danger">${result.getFieldError("password").getDefaultMessage()}</span>
										</div>
