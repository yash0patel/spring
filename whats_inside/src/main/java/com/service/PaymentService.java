...
public class PaymentService {
    ...
    @Value("${authorize.transaction.key}")
    private String transactionKey;
    
	public ANetApiResponse chargeCreditCardn(Double amount, PaymentBean paymentBean) {
        ...
        creditCard.setCardCode(paymentBean.getCvv());
