...
//	PasswordEncoder passwordEncoder;
	...
	public int deleteUserByEmail(String email) {
	    ...
	    return stmt.update(sql, email);  // returns number of rows affected
	}
	...
	public Boolean setOtp(String email, String otp) {
		...
		Integer count = stmt.queryForObject("select count(*) from otp_verification where email = ?", Integer.class,
				email);
		int rowsAffected = 0;
		if (count == 1) {
